    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Here are some of the personal and academic projects I’ve built to sharpen my
                    development skills,
                    explore new technologies, and bring ideas to life.
                    Each project reflects hands-on experience with tools like Laravel, Livewire, Alpine.js, and Bootstrap —
                    all while following modern web development practices.</p>
                <p>
                    ...
                    <div data-aos="zoom-in" class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Created Facebook with PHP, Hack (a PHP dialect), Python, C++, Java,
                                    Erlang, D, and Haskell.
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <a class="nav-link text-dark p-0" href="https://github.com/shuhailycasan"
                                            target="_blank">
