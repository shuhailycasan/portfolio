...
<div class="container px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div class="col-12 col-lg-6 d-flex justify-content-center  mb-lg-0">
            <img
            src="{{ asset('assets/images/me.jpg') }}"
            class="img-fluid rounded-circle mx-auto d-block transition"
            x-data="{ show: false }"
            x-init="setTimeout(() => show = true, 400)"
            x-bind:class="show ? 'scale-100 opacity-100' : 'scale-75 opacity-0'"
        ...
        <div class="col-lg-6 text-center text-lg-start">
            ...
            <p  data-aos="fade-right" class="lead">A Junior Developer focused on building simple, functional, and modern web apps using Laravel and the tools that make it fun. 
