...
@section('content')
    ...
    <div class="container">
        ...
        <p class="lead text-muted">I’m Shuhaily Casan, a junior developer who loves building clean, responsive web apps using Laravel, Livewire, and Alpine.js. 
    ...
    <div class="row">
        ...
        <ul class="list-group">
            ...
            Civil Service Eligible Professiona
