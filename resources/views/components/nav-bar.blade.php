<nav x-data="{ open: false }" class="navbar fixed-top navbar-expand-lg bg-white border-bottom shadow-sm m-3 rounded">
    <div class="container d-flex justify-content-around">
        <a class="navbar-brand ms-4" href="{{ url('/home') }}">Shuhaily Casan</a>

        <button @click = "open = !open" class="navbar-toggler me-4" type="button" data-bs-toggle="collapse"
